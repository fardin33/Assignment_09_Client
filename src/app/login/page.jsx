          ...
          <div className="flex min-h-155 items-center justify-center bg-white/80 dark:bg-[#0f234f]/80 px-5 py-8 sm:px-8 lg:px-12">
            <div className="w-full max-w-md">
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-2xl border border-[#006B4F]/20 bg-white px-5 py-3.5 text-sm font-black text-[#1f1b14] shadow-sm transition duration-300 disabled:pointer-events-none disabled:opacity-60 hover:-translate-y-0.5 hover:border-[#006B4F]/40 hover:bg-white hover:shadow-lg dark:border-[#F6F0E4]/15 dark:bg-white dark:text-[#1f1b14] dark:hover:bg-gray-100">
                <svg
                  className="h-5 w-5"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg">
