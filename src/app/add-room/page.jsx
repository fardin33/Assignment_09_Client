...
//     if (roomDetails.floor) roomDetails.floor = Number(roomDetails.floor);
//     if (roomDetails.capacity)
//       roomDetails.capacity = Number(roomDetails.capacity);
//     if (roomDetails.price) roomDetails.price = Number(roomDetails.price);

//     const amenities = formData.getAll("amenities");

//     roomDetails.amenities = amenities;

//     console.log("Sending Data to Backend:", roomDetails);
...
//       e.target.reset();
//     } else {
//       alert("Something went wrong. Could not add room.");
//     }
//   };
